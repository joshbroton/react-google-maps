...
var publicMethodMap = {
  ...
  setCenter: function setCenter(map, args) {
    return map.setCenter.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setHeading: function setHeading(map, args) {
    return map.setHeading.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setMapTypeId: function setMapTypeId(map, args) {
    return map.setMapTypeId.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setOptions: function setOptions(map, args) {
    return map.setOptions.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setStreetView: function setStreetView(map, args) {
    return map.setStreetView.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setTilt: function setTilt(map, args) {
    return map.setTilt.apply(map, (0, _toConsumableArray3.default)(args));
  },
  setZoom: function setZoom(map, args) {
    return map.setZoom.apply(map, (0, _toConsumableArray3.default)(args));
  }
};
